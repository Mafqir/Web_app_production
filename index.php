...
<head>
    ...
    <title>Login - Plannifier votre production</title>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.php"><img src="assets/images/logo/logoo.png" style="height: 80px;" alt="Logo"></a>
                    </div>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    ...
                    <br>
                    <br>
                    <img src="assets/images/2941288.png" style="height: 400px;" alt="Logo">
                </div>
            </div>
        </div>
