                ...
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Affichage des Produit</h4>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($tab as $t) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <a data-bs-toggle="modal" class="btn-cr" data-bs-target="#modifier<?= $t->get("i") ?>">
                                                                <svg class="bi" width="1em" height="1em" fill="currentColor">
                                                                    <use xlink:href="../../assets/images/bootstrap-icons.svg#pencil">
                                                                    </use>
                                                                </svg>
                                                            </a>&#124;
                                                            <a data-bs-toggle="modal" data-bs-target="#supprimer<?= $t->get("i") ?>">
                                                                <svg class="bi" width="1em" height="1em" fill="currentColor">
                                                        ...
                                                        <!-- -------------MODIFIER------------- -->
                                                        <div class="modal fade bd-example-modal-sm" id="modifier<?= $t->get("i") ?>" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="form form-vertical" method="post" action="modifierCategorie.php?id=<?= $t->get("i") ?>">
                                                                            <div class="form-body">
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <label for="first-name-vertical">Id</label>
                                                                                        <input type="text" name="id" class="form-control" disabled value=<?= $t->get("i") ?>>
                                                        ...
                                                        <div class="modal fade bd-example-modal-sm" id="supprimer<?= $t->get("i") ?>" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <!-- <h4 class="modal-title">Alert</h4> -->
                                                                        <p>Vous etes sure de supprimer ce
                                                                            Produit?!</p>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                        <a href='supprimerCategorie.php?id=<?= $t->get("i") ?>'>
