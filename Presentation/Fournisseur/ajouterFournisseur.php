                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="password-vertical" class="form-control" name="adresse" placeholder="Adresse">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="contact-info-vertical">Telephone</label>
                                                    <input type="number" id="contact-info-vertical" class="form-control" name="telephone" placeholder="Telephone">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
        ...
        <footer>
            <div class="footer clearfix mb-0 text-muted">
                <div class="float-start">
                    <p>2023/2024 &copy; Master IITN - ENSA Kenitra</p>
                </div>
            </div>
        </footer>
    </div>
