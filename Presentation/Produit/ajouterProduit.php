            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Ajout d'un Composants</h4>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" class="form-control" name="reference" placeholder="Reference">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="password-vertical">Libelle</label>
                                                <input type="text" id="password-vertical" class="form-control" name="libelle" placeholder="Libelle">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="contact-info-vertical">Prix unitaire</label>
                                                <input type="number" id="contact-info-vertical" class="form-control" name="prix" placeholder="Prix unitaire">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="email-id-vertical">Quantite </label>
                                                <input type="number" id="email-id-vertical" class="form-control" name="quantite" placeholder="Quantite ">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="email-id-vertical">Prix d'achat</label>
                                                <input type="number" id="email-id-vertical" class="form-control" name="achat" placeholder="Prix d'achat">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
