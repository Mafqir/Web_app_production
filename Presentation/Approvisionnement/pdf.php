...
$Fournisseur = DAO::getFournisseur($commande->get('i'));
    ...
    <div class="card-body" style="width:360px; border:1px black solid">
        <div class="form-group row text-left mb-0">
            <div style="display: flex; justify-content: center; margin:0 auto 15px auto; opacity:0.94;">
                <img width="110" src="../../assets/images/logo/logoo.png" alt="" class="logo logo-lg align-self-center">
            </div>
            <div class="col-sm-9">
                <h5 class="font-weight-bold">fiche d'approvisionement</h5>
            </div>
